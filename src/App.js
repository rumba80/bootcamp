...
function App() {
  const partner = [shidLogo, ITNLogo, gsLogo];
  const navLinks = [
    {
  ...
  const sectors = [
    {
      name: "Промышленность",
      imgUrl: require ('../src/assets/sectors/industry.jpg'),
    ...
    {
      name: "Транспорт",
      imgUrl: require ('../src/assets/sectors/transport.jpg'),
    ...
    },
    {
      ...
      imgUrl: require ('../src/assets/sectors/city_planing.jpg'),
    ...
    },
    {
      ...
      imgUrl: require ('../src/assets/sectors/utilisation.jpg'), 
  ...
  return (
    <>
      ...
      items={sectors}/>
      <AirQuality/>
      <Footer links={navLinks} partners={partner}/>
    </>
  );
}
